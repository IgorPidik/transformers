...
class TFDebertaMainLayer(tf.keras.layers.Layer):
    ...
    def __init__(self, config: DebertaConfig, add_pooling_layer=True, **kwargs):
        super().__init__(**kwargs)
        ...
        self.pooler = TFDebertaContextPooler(config, name="pooler") if add_pooling_layer else None
